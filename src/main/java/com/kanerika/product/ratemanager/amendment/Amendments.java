...
public class Amendments {
    ...
    public Amendments(Integer status, Long referenceId, Integer type, String description, Long ratesetId,
			Long ratesetReferenceId, Long buyerOrgId, Long sellerOrgId, String buyerOrgName, String sellerOrgName,
			String ratesetName, String region, String mode, Date defaultEffectiveDateFrom,
			Date defaultEffectiveDateThru, Long reviewedBy, Long createdBy, Long lastUpdatedBy, Long lastAssignedBy,
			String approvers, Long currentApprover, Timestamp dateApproved, Timestamp dateCreated, Timestamp dateUpdated,
			Timestamp dateReviewed, Timestamp dateAssigned) {
		super();
		this.status = status;
