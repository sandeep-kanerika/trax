...
public class RateRows {
    ...
    public RateRows(Long amendmentId, Integer amendmentType, String amendmentReferenceId, Long rootParentId,
			...
			Boolean hasError, Date effectiveDateFrom, Date effectiveDateThru, Date effectiveDate, String originCountry,
			String destinationCountry, String originStateProv, String destinationStateProv, String originCity,
			String destinationCity, String originPostalCode, String destinationPostalCode, String originPostalCodeRange,
			String originAirportCode, String destinationAirportCode, String originGateway, String destinationGateway,
			String originPortCountry, String destinationPortCountry, String originPortStateProv,
			String destinationPortStateProv, String originPortCity, String destinationPortCity, String originUnlocode,
			String destinationUnlocode, String originZone, String destinationZone, Double weightRangeFrom,
			Double weightRangeTo, Double weight, String equipmentType, String containerType, String vehicleType,
			String commodityType, String commodityClass, String volumetric, String mode, String modeType,
			String serviceScope, String serviceLevel, String packageType, String programName, String chargeDescription,
			String chargeCode, String rateBasic, String rateBasicUom, String rateType, Double rate, Double currency,
			Double baseRate, Double minRate, Double maxRate, Boolean breakpointFlag, Boolean consolidatedFlag,
			String discountFlag, String primaryIntermediateAirport, String backupIntermediateString,
		...
		this.originPortStateProv = originPortStateProv;
		this.destinationPortStateProv = destinationPortStateProv;
		...
		this.backupIntermediateString = backupIntermediateString;
	...
	public Long getTableDefinition() {
		return tableDefinition;
	}

	public void setTableDefinition(Long tableDefinition) {
		this.tableDefinition = tableDefinition;
	}
	...
	public String getoriginPortStateProv() {
		return originPortStateProv;
	}

	public void setoriginPortStateProv(String originPortStateProv) {
		this.originPortStateProv = originPortStateProv;
	}

	public String getdestinationPortStateProv() {
		return destinationPortStateProv;
	}

	public void setdestinationPortStateProv(String destinationPortStateProv) {
		this.destinationPortStateProv = destinationPortStateProv;
	}
...
//	}
	...
	public String getBackupIntermediateString() {
		return backupIntermediateString;
	}

	public void setBackupIntermediateString(String backupIntermediateString) {
		this.backupIntermediateString = backupIntermediateString;
	}
