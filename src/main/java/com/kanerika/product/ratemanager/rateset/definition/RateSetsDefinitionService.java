...
import com.kanerika.product.ratemanager.rateset.RateSets;
...
public class RateSetsDefinitionService extends AbstractJpaService<RateSetsDefinition> {
	...
	@Override
	protected AbstractJpaRepository<RateSetsDefinition, Long> getRepository() {
		// TODO Auto-generated method stub
		return rateSetsDefinitionRepository;
	}

	public RateSetsDefinition getById(Long id) {
		// TODO Auto-generated method stub
